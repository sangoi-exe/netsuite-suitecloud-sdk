...
module.exports = {
	...
	UTILS: {
		...
		AUTHENTICATION: {
			...
			OAUTH_BROWSER_LAUNCH_FAILED: 'UTILS_AUTHENTICATION_OAUTH_BROWSER_LAUNCH_FAILED',
			OAUTH_INVALID_SDK_SETTINGS: 'UTILS_AUTHENTICATION_OAUTH_INVALID_SDK_SETTINGS',
			OAUTH_TIMEOUT: 'UTILS_AUTHENTICATION_OAUTH_TIMEOUT',
			OAUTH_REFRESH_MISSING_ACCOUNT_ID: 'UTILS_AUTHENTICATION_OAUTH_REFRESH_MISSING_ACCOUNT_ID',
			OAUTH_REFRESH_MISSING_CLIENT_ID: 'UTILS_AUTHENTICATION_OAUTH_REFRESH_MISSING_CLIENT_ID',
			OAUTH_REFRESH_MISSING_TOKEN: 'UTILS_AUTHENTICATION_OAUTH_REFRESH_MISSING_TOKEN',
			OAUTH_REFRESH_ACCOUNT_MISMATCH: 'UTILS_AUTHENTICATION_OAUTH_REFRESH_ACCOUNT_MISMATCH',
			OAUTH_REFRESH_REQUEST_FAILED: 'UTILS_AUTHENTICATION_OAUTH_REFRESH_REQUEST_FAILED',
			OAUTH_REFRESH_RESPONSE_MISSING_ACCESS_TOKEN: 'UTILS_AUTHENTICATION_OAUTH_REFRESH_RESPONSE_MISSING_ACCESS_TOKEN',
			OAUTH_AUTHORIZATION_CODE_REQUEST_FAILED: 'UTILS_AUTHENTICATION_OAUTH_AUTHORIZATION_CODE_REQUEST_FAILED',
			OAUTH_AUTHORIZATION_CODE_RESPONSE_MISSING_ACCESS_TOKEN:
				'UTILS_AUTHENTICATION_OAUTH_AUTHORIZATION_CODE_RESPONSE_MISSING_ACCESS_TOKEN',
			OAUTH_AUTHORIZATION_FAILED: 'UTILS_AUTHENTICATION_OAUTH_AUTHORIZATION_FAILED',
			OAUTH_STATE_MISMATCH: 'UTILS_AUTHENTICATION_OAUTH_STATE_MISMATCH',
			OAUTH_CALLBACK_MISSING_CODE: 'UTILS_AUTHENTICATION_OAUTH_CALLBACK_MISSING_CODE',
			OAUTH_CALLBACK_MISSING_COMPANY: 'UTILS_AUTHENTICATION_OAUTH_CALLBACK_MISSING_COMPANY',
			OAUTH_CALLBACK_SERVER_UNAVAILABLE: 'UTILS_AUTHENTICATION_OAUTH_CALLBACK_SERVER_UNAVAILABLE',
		},
		ERRORS: {
